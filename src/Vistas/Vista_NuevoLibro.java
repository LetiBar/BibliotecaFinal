 ...
 * @author asdasd
 */
public class Vista_NuevoLibro extends javax.swing.JInternalFrame {

    LibroData libData = new LibroData();
    
    public Vista_NuevoLibro() {
        initComponents();
        estilos();
...
//       jlMensaje2.putClientProperty( "FlatLaf.styleClass" , "monospaced" );
    ...
    private void initComponents() {
        ...
        jbCargarEjemp = new javax.swing.JButton();
        ...
        jlTitulo.setText("NUEVO LIBRO");
        jlTitulo.setAlignmentX(0.5F);
        ...
        jbCargarEjemp.setFont(new java.awt.Font("Malgun Gothic Semilight", 1, 12)); // NOI18N
        jbCargarEjemp.setText("Cargar ejemplares");
        jbCargarEjemp.setPreferredSize(new java.awt.Dimension(120, 40));
        jbCargarEjemp.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbCargarEjempActionPerformed(evt);
            }
        });
        ...
        jLabel1.setText("Cargue los datos del nuevo libro.");

        jLabel10.setFont(new java.awt.Font("Malgun Gothic Semilight", 1, 12)); // NOI18N
        jLabel10.setText("Si necesita cargar los ejemplares de un libro existente, búsquelo por su n° de Id.");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(235, 235, 235))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addComponent(jbCargarEjemp, javax.swing.GroupLayout.PREFERRED_SIZE, 181, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(395, 395, 395))))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jbSalir, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(39, 39, 39)
                .addComponent(jbCargarEjemp, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jbGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbGuardarActionPerformed
       ...
       try {
            ...
            Libro libroNuevo = new Libro(isbn, titulo, autor, genero, editorial, estado);

            if (titulo.isEmpty() || autor.isEmpty() || genero.isEmpty() || editorial.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Todos los campos son obligatorios ");
            } else {
                libData.guardarLibro(libroNuevo);
    ...
    private void jbCargarEjempActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbCargarEjempActionPerformed
            int idLibro = Integer.parseInt(jtId.getText());
            int isbn = Integer.parseInt(jtIsbn.getText());
            String titulo = jtTitulo.getText();
            String autor = jtAutor.getText();
            String genero = jtGenero.getText();
            ...
            Libro libroNuevo = new Libro(idLibro, isbn, titulo, autor, genero, editorial, estado);
            
        if(libroNuevo.getTitulo() == null){
            JOptionPane.showMessageDialog(this, "Debe guardar los datos del libro antes de cargar los ejemplares. ");
        }else{
            
            CargarEjemplares cargarEj = new CargarEjemplares();
            cargarEj.setIdLibro(libroNuevo);
            cargarEj.setVisible(true);
        }        
    }//GEN-LAST:event_jbCargarEjempActionPerformed
    ...
    private javax.swing.JButton jbCargarEjemp;
